...
typedef struct vmiIASAttrS {
    ...
    vmiParamValueSizeFn paramValueSizeCB;   // Get size of parameter values table

    vmiParamSpecsFn     preParamSpecsCB;    // Iterator to get list of
                                            // model parameters required before
                                            // construction
    vmiParamSpecsFn     paramSpecsCB;       // Iterator to get full list of
                                            // model parameters

    vmiSetParamValuesFn preParamValuesCB;   // Called by simulator to set pointer
                                            // to table of values
