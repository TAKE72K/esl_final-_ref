...
int main(int argc, const char *argv[]) {
    ...
    // Instance module
    //
    const char *moduleVLNV = opVLNVString(NULL, "arm.ovpworld.org", "module", MODULE_NAME, "1.0", OP_MODULE, True);
    if (!moduleVLNV) {
        opMessage("E", HARNESS_NAME, "Did not find required module at IMPERAS_VLNV/arm.ovpworld.org/module/" MODULE_NAME "/1.0");
    }
