...
static const char *selectVendor() {
    ...
    for(i=0;i<NUMBER_VENDORS;i++){
        const char *mipsModel    = opVLNVString(NULL, vendors[index], "processor", "mips32_r1r5", "1.0", OP_PROCESSOR, 0);
        const char *mipsSemihost = opVLNVString(NULL, vendors[index], "semihosting", "mips32Newlib", "1.0", OP_EXTENSION, 0);
...
int main(int argc, char ** argv) {
    ...
    const char *model    =
        opVLNVString(NULL, vendor, "processor", "mips32_r1r5", "1.0", OP_PROCESSOR, 0);
