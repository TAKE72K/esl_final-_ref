...
VECTOR EXTENSION ---------------------------------------------------
  ...
  ELF Compilation ---------------------------------------------------
    There is currently no standard cross compiler available to generate
    the provided ELF files from the C files.
    These ELF files are, therefore, provided pre-compiled using a 
    combination of C compiler and binutils from different sources.
