...
FILE:Imperas/Examples/SimulationControl/minimalHarnessUsingCPP/README.txt


INTRODUCTION -------------------------------------------------------
This directory contains an example from the Simulation Control of 
Platforms and Modules User Guide.
...
3. A harness;
    harness/harness.cpp        the C++ code to instance a module and simulate
