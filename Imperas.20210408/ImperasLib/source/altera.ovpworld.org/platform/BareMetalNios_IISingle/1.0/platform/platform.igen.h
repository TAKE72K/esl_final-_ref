...
static OP_CONSTRUCT_FN(instantiateComponents) {
    ...
    opDocTextAdd(doc_21_node, "BareMetal platform for execution of Nios_II binary files compiled with CodeSourcery CrossCompiler toolchain.");
    ...
    const char *nios_iiNewlib_0_expath = opVLNVString(
        0, // use the default VLNV path
        "altera.ovpworld.org",
        "semihosting",
        "nios_iiNewlib",
