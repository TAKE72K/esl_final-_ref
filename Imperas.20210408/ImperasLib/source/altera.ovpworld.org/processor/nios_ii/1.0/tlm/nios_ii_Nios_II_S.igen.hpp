...
class nios_ii_Nios_II_S : public tlmProcessor
{
  private:
    params paramsForProc(params p) {
        p.set("variant", "Nios_II_S");
        return p;
    }
  ...
  public:
    ...
    nios_ii_Nios_II_S(tlmModule &parent, sc_module_name name)
    ...
    nios_ii_Nios_II_S(tlmModule &parent, sc_module_name name, params p, Uns32 INSTRUCTIONWidth=32, Uns32 DATAWidth=32)
