...
class nios_ii : public tlmProcessor
{
  private:
  ...
  public:
    ...
    nios_ii(tlmModule &parent, sc_module_name name)
    ...
    nios_ii(tlmModule &parent, sc_module_name name, params p, Uns32 INSTRUCTIONWidth=32, Uns32 DATAWidth=32)
