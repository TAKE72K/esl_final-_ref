...
// eg. if (diagnosticLevel >= 1) bhmMessage("I", "SystemIDCore", "Example");
...
PPM_DOC_FN(installDocs){
    ...
    ppmDocNodeP Root1_node = ppmDocAddSection(0, "Root");
    {
        ...
        ppmDocAddText(doc_12_node, "Altera Avalon System ID Core");
