...
class riscv_CV32E40S : public tlmProcessor
{
  private:
    params paramsForProc(params p) {
        p.set("variant", "CV32E40S");
        return p;
    }
  ...
  public:
    ...
    riscv_CV32E40S(tlmModule &parent, sc_module_name name)
    ...
    riscv_CV32E40S(tlmModule &parent, sc_module_name name, params p, Uns32 INSTRUCTIONWidth=34, Uns32 DATAWidth=34, Uns32 CSRWidth=16)
