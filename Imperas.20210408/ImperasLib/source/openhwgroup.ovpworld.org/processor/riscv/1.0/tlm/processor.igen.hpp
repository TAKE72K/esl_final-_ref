...
class riscv : public tlmProcessor
{
  private:
  ...
  public:
    ...
    riscv(tlmModule &parent, sc_module_name name)
    ...
    riscv(tlmModule &parent, sc_module_name name, params p, Uns32 INSTRUCTIONWidth=34, Uns32 DATAWidth=34, Uns32 CSRWidth=16)
