...
class riscv_CV32A6 : public tlmProcessor
{
  private:
    params paramsForProc(params p) {
        p.set("variant", "CV32A6");
        return p;
    }
  ...
  public:
    ...
    riscv_CV32A6(tlmModule &parent, sc_module_name name)
    ...
    riscv_CV32A6(tlmModule &parent, sc_module_name name, params p, Uns32 INSTRUCTIONWidth=34, Uns32 DATAWidth=34)
