...
class riscv_CV64A6 : public tlmProcessor
{
  private:
    params paramsForProc(params p) {
        p.set("variant", "CV64A6");
        return p;
    }
  ...
  public:
    ...
    riscv_CV64A6(tlmModule &parent, sc_module_name name)
    ...
    riscv_CV64A6(tlmModule &parent, sc_module_name name, params p, Uns32 INSTRUCTIONWidth=56, Uns32 DATAWidth=56)
