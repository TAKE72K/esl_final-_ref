...
#define MODULE_NAME "ArmCortexMuCOS-II"
...
int main(int argc, const char *argv[]) {
    ...
    if(options.kernel) {
        opMessage("I", MODULE_NAME"_LOAD", "Loading kernel file %s", options.kernel);
    ...
    opMessage("I", MODULE_NAME, "Running Micrium uC/OS-II Multitasking Kernel");
