...
static OP_CONSTRUCT_FN(instantiateComponents) {
    ...
    opDocTextAdd(doc_11_node, "This platform instances an ARM IntegratorCP with a Xilinx Microbalzed based sub-system");
    ...
    opDocTextAdd(doc_31_node, "ARM Development Boards Integrator CP BaseBoard and Integrator Core Modules ARM9x6 and Cortex-A9");
    ...
    // Module Instance integratorcp

    const char *integratorcp_path = opVLNVString(
        0, // use the default VLNV path
        "arm.ovpworld.org",
        "module",
        "ArmIntegratorCP",
