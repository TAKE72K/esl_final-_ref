...
class riscv_N25 : public tlmProcessor
{
  private:
  ...
  public:
    ...
    riscv_N25(tlmModule &parent, sc_module_name name)
    ...
    riscv_N25(tlmModule &parent, sc_module_name name, params p, Uns32 INSTRUCTIONWidth=34, Uns32 DATAWidth=34)
