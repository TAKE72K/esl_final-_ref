...
inline static void writeRegSize(
    ...
    riscv->cb.writeRegSize(riscv, r, srcBits, True);
}
...
//
static void emitValidateSEW(riscvP riscv, Uns32 SEW) {
    ...
    ILLEGAL_INSTRUCTION_MESSAGE(riscv, "RVSEW", "Illegal when SEW!=16");
...
static ANDES_MORPH_FN(emitVFWCVT_S_BF16) {
    ...
    emitValidateSEW(state->riscv, 16);
