...
imodeladdnetport -name resetNet  -type input -updatefunction resetCB
...
imodeladdmmregister -addressblock ${port}/${block} -name mtime  \
                    ...
                    -readfunction rdMTIME -writefunction wrMTIME
iadddocumentation -name Description -text "Constant frequency real-time counter"

imodeladdreset -mmregister ${port}/${block}/mtime -name resetNet
...
imodeladdreset -mmregister ${port}/${block}/mtimecmp%u -name resetNet
# 64-bit resets must be performed on a field (dummy in this case)
