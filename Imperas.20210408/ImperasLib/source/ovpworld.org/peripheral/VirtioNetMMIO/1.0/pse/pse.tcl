...
set registers {
    ...
    HostFeatures  0x010   r  rdHostF   -           -        -    0x00000000 -          "Host features flags"
...
#
imodeladdlocalmemory -name NetConfig -addressblock $addBlock -offset 0x100 -size 0x100 -nbyte -access r -readfunction readCfg
