...
// To access local memory bport1/ab/BlkConfig : (for example)
// char value = ((char*)handles.bport1)[BPORT1_AB_BLKCONFIG_OFFSET + myAddress];

#define BPORT1_AB_BLKCONFIG_OFFSET      0x100
#define BPORT1_AB_BLKCONFIG_SIZE        0x100
