...
static void installSlavePorts(void) {
    ...
    ppmInstallNByteCallbacks(readCfg, 0, 0, handles.bport1, 0x100, 0x100, 1, 0, 1, BHM_ENDIAN_LITTLE);
}
...
PPM_NET_CB(reset_Reset) {
    if(value != 0 ) {
        ...
        bport1_ab_data.HostFeatures.value = (Uns32)(bport1_ab_data.HostFeatures.value & ~(0xffffffff)) | ((0xffffffff) & (0x08000000));
        bport1_ab_data.VendorID.value = (Uns32)(bport1_ab_data.VendorID.value & ~(0xffffffff)) | ((0xffffffff) & (0x0050564F));
        bport1_ab_data.DeviceID.value = (Uns32)(bport1_ab_data.DeviceID.value & ~(0xffffffff)) | ((0xffffffff) & (0x00000002));
