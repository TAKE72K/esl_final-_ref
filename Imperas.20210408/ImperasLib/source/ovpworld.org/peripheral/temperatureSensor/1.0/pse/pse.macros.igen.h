...
#define BUSPORT_A_DATA_POFFSET          0x0
#define BUSPORT_A_DATA                  (BUSPORT + BUSPORT_A_POFFSET + BUSPORT_A_DATA_POFFSET)
#define BUSPORT_A_DATA_SBIT             (0x1 << 31)
#define BUSPORT_A_DATA_SBIT_GET(_v)     ((_v >> 31) & 0x1)
#define BUSPORT_A_DATA_DATA             0x7fffffff
#define BUSPORT_A_DATA_DATA_GET(_v)     (_v & 0x7fffffff)
