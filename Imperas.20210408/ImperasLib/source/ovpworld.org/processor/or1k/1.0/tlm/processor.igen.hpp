...
class or1k : public tlmProcessor
{
  private:
  ...
  public:
    ...
    or1k(tlmModule &parent, sc_module_name name)
    ...
    or1k(tlmModule &parent, sc_module_name name, params p, Uns32 INSTRUCTIONWidth=32, Uns32 DATAWidth=32)
