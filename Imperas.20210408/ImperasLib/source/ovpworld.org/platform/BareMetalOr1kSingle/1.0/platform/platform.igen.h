...
static OP_CONSTRUCT_FN(instantiateComponents) {
    ...
    opDocTextAdd(doc_21_node, "BareMetal platform for execution of OR1K binary files compiled with OR1K CrossCompiler toolchain.");
