...
class v850_V850 : public tlmProcessor
{
  private:
  ...
  public:
    ...
    v850_V850(tlmModule &parent, sc_module_name name)
    ...
    v850_V850(tlmModule &parent, sc_module_name name, params p, Uns32 INSTRUCTIONWidth=28, Uns32 DATAWidth=28)
