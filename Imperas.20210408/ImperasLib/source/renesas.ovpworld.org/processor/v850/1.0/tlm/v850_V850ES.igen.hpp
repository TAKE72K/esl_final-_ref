...
class v850_V850ES : public tlmProcessor
{
  private:
    params paramsForProc(params p) {
        p.set("variant", "V850ES");
        return p;
    }
  ...
  public:
    ...
    v850_V850ES(tlmModule &parent, sc_module_name name)
    ...
    v850_V850ES(tlmModule &parent, sc_module_name name, params p, Uns32 INSTRUCTIONWidth=28, Uns32 DATAWidth=28)
