...
class v850_V850E1 : public tlmProcessor
{
  private:
    params paramsForProc(params p) {
        p.set("variant", "V850E1");
        return p;
    }
  ...
  public:
    ...
    v850_V850E1(tlmModule &parent, sc_module_name name)
    ...
    v850_V850E1(tlmModule &parent, sc_module_name name, params p, Uns32 INSTRUCTIONWidth=28, Uns32 DATAWidth=28)
