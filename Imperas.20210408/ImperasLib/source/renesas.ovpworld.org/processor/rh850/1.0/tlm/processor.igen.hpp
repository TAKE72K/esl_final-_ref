...
class rh850 : public tlmProcessor
{
  private:
  ...
  public:
    ...
    rh850(tlmModule &parent, sc_module_name name)
    ...
    rh850(tlmModule &parent, sc_module_name name, params p, Uns32 INSTRUCTIONWidth=28, Uns32 DATAWidth=28)
