...
class rl78 : public tlmProcessor
{
  private:
  ...
  public:
    ...
    rl78(tlmModule &parent, sc_module_name name)
    ...
    rl78(tlmModule &parent, sc_module_name name, params p, Uns32 INSTRUCTIONWidth=20, Uns32 DATAWidth=20)
