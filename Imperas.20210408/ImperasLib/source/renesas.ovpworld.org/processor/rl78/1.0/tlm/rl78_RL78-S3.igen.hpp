...
class rl78_RL78_S3 : public tlmProcessor
{
  private:
    params paramsForProc(params p) {
        p.set("variant", "RL78-S3");
        return p;
    }
  ...
  public:
    ...
    rl78_RL78_S3(tlmModule &parent, sc_module_name name)
    ...
    rl78_RL78_S3(tlmModule &parent, sc_module_name name, params p, Uns32 INSTRUCTIONWidth=20, Uns32 DATAWidth=20)
