...
static OP_CONSTRUCT_FN(instantiateComponents) {
    ...
    opDocTextAdd(doc_21_node, "BareMetal platform to support images generated with Greenhills Compiler targeting a V850E1 Processor");
    ...
    optProcessorP cpu1_c = opProcessorNew(
        ...
        OP_PARAMS(
            ...
            ,OP_PARAM_ENUM_SET("variant", "V850E1")
        )
    );

    const char *v850Newlib_0_expath = opVLNVString(
        0, // use the default VLNV path
        0,
        0,
        "v850Newlib",
