...
class armm_Cortex_M3 : public tlmProcessor
{
  private:
  ...
  public:
    ...
    armm_Cortex_M3(tlmModule &parent, sc_module_name name)
    ...
    armm_Cortex_M3(tlmModule &parent, sc_module_name name, params p, Uns32 INSTRUCTIONWidth=32, Uns32 DATAWidth=32)
