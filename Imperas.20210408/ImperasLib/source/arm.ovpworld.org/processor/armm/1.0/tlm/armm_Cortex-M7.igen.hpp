...
class armm_Cortex_M7 : public tlmProcessor
{
  private:
    params paramsForProc(params p) {
        p.set("variant", "Cortex-M7");
        return p;
    }
  ...
  public:
    ...
    armm_Cortex_M7(tlmModule &parent, sc_module_name name)
    ...
    armm_Cortex_M7(tlmModule &parent, sc_module_name name, params p, Uns32 INSTRUCTIONWidth=32, Uns32 DATAWidth=32, Uns32 ITCMWidth=32, Uns32 DTCMWidth=32)
