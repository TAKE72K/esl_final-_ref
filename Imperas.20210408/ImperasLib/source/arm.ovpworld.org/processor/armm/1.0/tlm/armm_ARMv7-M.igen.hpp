...
class armm_ARMv7_M : public tlmProcessor
{
  private:
    params paramsForProc(params p) {
        p.set("variant", "ARMv7-M");
        return p;
    }
  ...
  public:
    ...
    armm_ARMv7_M(tlmModule &parent, sc_module_name name)
    ...
    armm_ARMv7_M(tlmModule &parent, sc_module_name name, params p, Uns32 INSTRUCTIONWidth=32, Uns32 DATAWidth=32)
