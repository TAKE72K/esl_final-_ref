...
class armm_Cortex_M23 : public tlmProcessor
{
  private:
    params paramsForProc(params p) {
        p.set("variant", "Cortex-M23");
        return p;
    }
  ...
  public:
    ...
    armm_Cortex_M23(tlmModule &parent, sc_module_name name)
    ...
    armm_Cortex_M23(tlmModule &parent, sc_module_name name, params p, Uns32 INSTRUCTIONWidth=32, Uns32 DATAWidth=32)
