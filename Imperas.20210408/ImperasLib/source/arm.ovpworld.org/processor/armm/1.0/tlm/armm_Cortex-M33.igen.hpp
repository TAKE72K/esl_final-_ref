...
class armm_Cortex_M33 : public tlmProcessor
{
  private:
    params paramsForProc(params p) {
        p.set("variant", "Cortex-M33");
        return p;
    }
  ...
  public:
    ...
    armm_Cortex_M33(tlmModule &parent, sc_module_name name)
    ...
    armm_Cortex_M33(tlmModule &parent, sc_module_name name, params p, Uns32 INSTRUCTIONWidth=32, Uns32 DATAWidth=32)
