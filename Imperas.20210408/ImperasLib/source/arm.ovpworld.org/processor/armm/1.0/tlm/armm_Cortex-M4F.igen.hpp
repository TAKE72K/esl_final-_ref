...
class armm_Cortex_M4F : public tlmProcessor
{
  private:
    params paramsForProc(params p) {
        p.set("variant", "Cortex-M4F");
        return p;
    }
  ...
  public:
    ...
    armm_Cortex_M4F(tlmModule &parent, sc_module_name name)
    ...
    armm_Cortex_M4F(tlmModule &parent, sc_module_name name, params p, Uns32 INSTRUCTIONWidth=32, Uns32 DATAWidth=32)
