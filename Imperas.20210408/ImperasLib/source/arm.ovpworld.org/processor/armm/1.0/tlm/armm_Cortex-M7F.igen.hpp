...
class armm_Cortex_M7F : public tlmProcessor
{
  private:
    params paramsForProc(params p) {
        p.set("variant", "Cortex-M7F");
        return p;
    }
    ...
    const char *getModel() {
        const char *vlnv = opVLNVString (NULL, "arm.ovpworld.org", "processor", "armm", "1.0", OP_PROCESSOR, 1);
        if(!vlnv) {
            opMessage("F", "TLM_FFM", "Failed to find model arm.ovpworld.org/processor/armm/1.0");
        }
        return vlnv;
    }
  ...
  public:
    ...
    tlmBusMasterPort     ITCM;
    tlmBusMasterPort     DTCM;
    ...
    armm_Cortex_M7F(tlmModule &parent, sc_module_name name, params p, Uns32 INSTRUCTIONWidth=32, Uns32 DATAWidth=32, Uns32 ITCMWidth=32, Uns32 DTCMWidth=32)
    ...
    , ITCM (parent, this, "ITCM", ITCMWidth)
    , DTCM (parent, this, "DTCM", DTCMWidth)
    , sysResetReq(parent, this, "sysResetReq")
    , intISS(parent, this, "intISS")
    , eventOut(parent, this, "eventOut")
    , lockup(parent, this, "lockup")
