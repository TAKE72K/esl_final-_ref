...
class arm_ARMv5xM : public tlmProcessor
{
  private:
    params paramsForProc(params p) {
        p.set("variant", "ARMv5xM");
        return p;
    }
  ...
  public:
    ...
    arm_ARMv5xM(tlmModule &parent, sc_module_name name)
    ...
    arm_ARMv5xM(tlmModule &parent, sc_module_name name, params p, Uns32 INSTRUCTIONWidth=32, Uns32 DATAWidth=32)
