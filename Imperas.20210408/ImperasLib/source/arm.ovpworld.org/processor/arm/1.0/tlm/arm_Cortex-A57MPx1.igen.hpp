...
class arm_Cortex_A57MPx1 : public tlmProcessor
{
  private:
  ...
  public:
    ...
    arm_Cortex_A57MPx1(tlmModule &parent, sc_module_name name)
    ...
    arm_Cortex_A57MPx1(tlmModule &parent, sc_module_name name, params p, Uns32 INSTRUCTIONWidth=44, Uns32 DATAWidth=44, Uns32 GICRegistersWidth=32)
