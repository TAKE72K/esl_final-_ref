...
class arm_Cortex_A7UP : public tlmProcessor
{
  private:
    params paramsForProc(params p) {
        p.set("variant", "Cortex-A7UP");
        return p;
    }
  ...
  public:
    ...
    arm_Cortex_A7UP(tlmModule &parent, sc_module_name name)
    ...
    arm_Cortex_A7UP(tlmModule &parent, sc_module_name name, params p, Uns32 INSTRUCTIONWidth=40, Uns32 DATAWidth=40)
