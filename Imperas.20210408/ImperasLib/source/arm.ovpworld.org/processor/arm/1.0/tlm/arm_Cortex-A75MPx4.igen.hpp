...
class arm_Cortex_A75MPx4 : public tlmProcessor
{
  private:
    params paramsForProc(params p) {
        p.set("variant", "Cortex-A75MPx4");
        return p;
    }
  ...
  public:
    ...
    tlmNetOutputPort     CNTHVIRQ_CPU0;
    ...
    tlmNetInputPort      RVBARADDRx_CPU0;
    tlmNetInputPort      AA64nAA32_CPU0;
    ...
    tlmNetOutputPort     CNTHVIRQ_CPU1;
    tlmNetOutputPort     IRQOUT_CPU1;
    tlmNetOutputPort     FIQOUT_CPU1;
    tlmNetInputPort      RVBARADDRx_CPU1;
    tlmNetInputPort      AA64nAA32_CPU1;
    ...
    tlmNetOutputPort     CNTHVIRQ_CPU2;
    tlmNetOutputPort     IRQOUT_CPU2;
    tlmNetOutputPort     FIQOUT_CPU2;
    tlmNetInputPort      RVBARADDRx_CPU2;
    tlmNetInputPort      AA64nAA32_CPU2;
    ...
    tlmNetOutputPort     PMUIRQ_CPU2;
    tlmNetInputPort      PPI16_CPU3;
    tlmNetInputPort      PPI17_CPU3;
    tlmNetInputPort      PPI18_CPU3;
    tlmNetInputPort      PPI19_CPU3;
    tlmNetInputPort      PPI20_CPU3;
    tlmNetInputPort      PPI21_CPU3;
    tlmNetInputPort      PPI22_CPU3;
    tlmNetInputPort      PPI23_CPU3;
    tlmNetInputPort      PPI24_CPU3;
    tlmNetInputPort      PPI25_CPU3;
    tlmNetInputPort      PPI26_CPU3;
    tlmNetInputPort      PPI27_CPU3;
    tlmNetInputPort      PPI28_CPU3;
    tlmNetInputPort      PPI29_CPU3;
    tlmNetInputPort      PPI30_CPU3;
    tlmNetInputPort      PPI31_CPU3;
    ...
    tlmNetOutputPort     CNTHVIRQ_CPU3;
    tlmNetOutputPort     IRQOUT_CPU3;
    tlmNetOutputPort     FIQOUT_CPU3;
    tlmNetInputPort      RVBARADDRx_CPU3;
    tlmNetInputPort      AA64nAA32_CPU3;
    tlmNetInputPort      VINITHI_CPU3;
    tlmNetInputPort      CFGEND_CPU3;
    tlmNetInputPort      CFGTE_CPU3;
    ...
    tlmNetOutputPort     PMUIRQ_CPU3;

    arm_Cortex_A75MPx4(tlmModule &parent, sc_module_name name)
    ...
    , CNTHVIRQ_CPU0(parent, this, "CNTHVIRQ_CPU0")
    ...
    , RVBARADDRx_CPU0(parent, this, "RVBARADDRx_CPU0")
    , AA64nAA32_CPU0(parent, this, "AA64nAA32_CPU0")
    ...
    , CNTHVIRQ_CPU1(parent, this, "CNTHVIRQ_CPU1")
    , IRQOUT_CPU1(parent, this, "IRQOUT_CPU1")
    , FIQOUT_CPU1(parent, this, "FIQOUT_CPU1")
    , RVBARADDRx_CPU1(parent, this, "RVBARADDRx_CPU1")
    , AA64nAA32_CPU1(parent, this, "AA64nAA32_CPU1")
    ...
    , PMUIRQ_CPU1(parent, this, "PMUIRQ_CPU1")
    ...
    , CNTHVIRQ_CPU2(parent, this, "CNTHVIRQ_CPU2")
    , IRQOUT_CPU2(parent, this, "IRQOUT_CPU2")
    , FIQOUT_CPU2(parent, this, "FIQOUT_CPU2")
    , RVBARADDRx_CPU2(parent, this, "RVBARADDRx_CPU2")
    , AA64nAA32_CPU2(parent, this, "AA64nAA32_CPU2")
    ...
    , PMUIRQ_CPU2(parent, this, "PMUIRQ_CPU2")
    , PPI16_CPU3(parent, this, "PPI16_CPU3")
    , PPI17_CPU3(parent, this, "PPI17_CPU3")
    , PPI18_CPU3(parent, this, "PPI18_CPU3")
    , PPI19_CPU3(parent, this, "PPI19_CPU3")
    , PPI20_CPU3(parent, this, "PPI20_CPU3")
    , PPI21_CPU3(parent, this, "PPI21_CPU3")
    , PPI22_CPU3(parent, this, "PPI22_CPU3")
    , PPI23_CPU3(parent, this, "PPI23_CPU3")
    , PPI24_CPU3(parent, this, "PPI24_CPU3")
    , PPI25_CPU3(parent, this, "PPI25_CPU3")
    , PPI26_CPU3(parent, this, "PPI26_CPU3")
    , PPI27_CPU3(parent, this, "PPI27_CPU3")
    , PPI28_CPU3(parent, this, "PPI28_CPU3")
    , PPI29_CPU3(parent, this, "PPI29_CPU3")
    , PPI30_CPU3(parent, this, "PPI30_CPU3")
    , PPI31_CPU3(parent, this, "PPI31_CPU3")
    ...
    , CNTHVIRQ_CPU3(parent, this, "CNTHVIRQ_CPU3")
    , IRQOUT_CPU3(parent, this, "IRQOUT_CPU3")
    , FIQOUT_CPU3(parent, this, "FIQOUT_CPU3")
    , RVBARADDRx_CPU3(parent, this, "RVBARADDRx_CPU3")
    , AA64nAA32_CPU3(parent, this, "AA64nAA32_CPU3")
    , VINITHI_CPU3(parent, this, "VINITHI_CPU3")
    , CFGEND_CPU3(parent, this, "CFGEND_CPU3")
    , CFGTE_CPU3(parent, this, "CFGTE_CPU3")
    ...
    , PMUIRQ_CPU3(parent, this, "PMUIRQ_CPU3")
    {
    }

    arm_Cortex_A75MPx4(tlmModule &parent, sc_module_name name, params p, Uns32 INSTRUCTIONWidth=44, Uns32 DATAWidth=44, Uns32 GICRegistersWidth=32, Uns32 GICDRegistersWidth=32)
