...
class arm_ARM1136J_S : public tlmProcessor
{
  private:
    params paramsForProc(params p) {
        p.set("variant", "ARM1136J-S");
        return p;
    }
  ...
  public:
    ...
    arm_ARM1136J_S(tlmModule &parent, sc_module_name name)
    ...
    arm_ARM1136J_S(tlmModule &parent, sc_module_name name, params p, Uns32 ITCM0Width=32, Uns32 DTCM0Width=32, Uns32 INSTRUCTIONWidth=32, Uns32 DATAWidth=32)
