...
class arm_ARMv5 : public tlmProcessor
{
  private:
  ...
  public:
    ...
    arm_ARMv5(tlmModule &parent, sc_module_name name)
    ...
    arm_ARMv5(tlmModule &parent, sc_module_name name, params p, Uns32 INSTRUCTIONWidth=32, Uns32 DATAWidth=32)
