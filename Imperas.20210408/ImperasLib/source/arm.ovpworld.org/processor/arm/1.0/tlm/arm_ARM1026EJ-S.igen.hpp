...
class arm_ARM1026EJ_S : public tlmProcessor
{
  private:
    params paramsForProc(params p) {
        p.set("variant", "ARM1026EJ-S");
        return p;
    }
  ...
  public:
    ...
    arm_ARM1026EJ_S(tlmModule &parent, sc_module_name name)
    ...
    arm_ARM1026EJ_S(tlmModule &parent, sc_module_name name, params p, Uns32 INSTRUCTIONWidth=32, Uns32 DATAWidth=32)
