...
class arm_ARM920T : public tlmProcessor
{
  private:
    params paramsForProc(params p) {
        p.set("variant", "ARM920T");
        return p;
    }
  ...
  public:
    ...
    arm_ARM920T(tlmModule &parent, sc_module_name name)
    ...
    arm_ARM920T(tlmModule &parent, sc_module_name name, params p, Uns32 INSTRUCTIONWidth=32, Uns32 DATAWidth=32)
