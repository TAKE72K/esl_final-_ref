...
class arm_Cortex_A57MPx4 : public tlmProcessor
{
  private:
    params paramsForProc(params p) {
        p.set("variant", "Cortex-A57MPx4");
        return p;
    }
  ...
  public:
    ...
    arm_Cortex_A57MPx4(tlmModule &parent, sc_module_name name)
    ...
    arm_Cortex_A57MPx4(tlmModule &parent, sc_module_name name, params p, Uns32 INSTRUCTIONWidth=44, Uns32 DATAWidth=44, Uns32 GICRegistersWidth=32)
