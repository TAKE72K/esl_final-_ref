...
class arm_Cortex_A35MPx4 : public tlmProcessor
{
  private:
    params paramsForProc(params p) {
        p.set("variant", "Cortex-A35MPx4");
        return p;
    }
  ...
  public:
    ...
    tlmNetOutputPort     SMPEN_CPU3;

    arm_Cortex_A35MPx4(tlmModule &parent, sc_module_name name)
    ...
    , SMPEN_CPU1(parent, this, "SMPEN_CPU1")
    ...
    , SMPEN_CPU2(parent, this, "SMPEN_CPU2")
    ...
    , SMPEN_CPU3(parent, this, "SMPEN_CPU3")
    {
    }

    arm_Cortex_A35MPx4(tlmModule &parent, sc_module_name name, params p, Uns32 INSTRUCTIONWidth=40, Uns32 DATAWidth=40, Uns32 GICRegistersWidth=32, Uns32 GICDRegistersWidth=32)
