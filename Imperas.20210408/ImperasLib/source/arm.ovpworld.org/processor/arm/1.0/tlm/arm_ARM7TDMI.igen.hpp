...
class arm_ARM7TDMI : public tlmProcessor
{
  private:
  ...
  public:
    ...
    arm_ARM7TDMI(tlmModule &parent, sc_module_name name)
    ...
    arm_ARM7TDMI(tlmModule &parent, sc_module_name name, params p, Uns32 INSTRUCTIONWidth=32, Uns32 DATAWidth=32)
