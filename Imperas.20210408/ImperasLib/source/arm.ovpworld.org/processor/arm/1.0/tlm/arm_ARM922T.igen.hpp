...
class arm_ARM922T : public tlmProcessor
{
  private:
    params paramsForProc(params p) {
        p.set("variant", "ARM922T");
        return p;
    }
  ...
  public:
    ...
    arm_ARM922T(tlmModule &parent, sc_module_name name)
    ...
    arm_ARM922T(tlmModule &parent, sc_module_name name, params p, Uns32 INSTRUCTIONWidth=32, Uns32 DATAWidth=32)
