...
class arm_ARM926EJ_S : public tlmProcessor
{
  private:
    params paramsForProc(params p) {
        p.set("variant", "ARM926EJ-S");
        return p;
    }
  ...
  public:
    ...
    arm_ARM926EJ_S(tlmModule &parent, sc_module_name name)
    ...
    arm_ARM926EJ_S(tlmModule &parent, sc_module_name name, params p, Uns32 ITCM0Width=32, Uns32 DTCM0Width=32, Uns32 INSTRUCTIONWidth=32, Uns32 DATAWidth=32)
