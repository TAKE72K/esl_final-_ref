...
class arm : public tlmProcessor
{
  ...
  public:
    ...
    arm(tlmModule &parent, sc_module_name name)
    ...
    arm(tlmModule &parent, sc_module_name name, params p, Uns32 INSTRUCTIONWidth=32, Uns32 DATAWidth=32)
