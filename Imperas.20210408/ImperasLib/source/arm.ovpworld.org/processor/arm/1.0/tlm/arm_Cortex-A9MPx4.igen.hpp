...
class arm_Cortex_A9MPx4 : public tlmProcessor
{
  private:
    params paramsForProc(params p) {
        p.set("variant", "Cortex-A9MPx4");
        return p;
    }
  ...
  public:
    ...
    tlmNetOutputPort     wdResetReq_CPU3;
    tlmNetInputPort      wdReset_CPU3;
    tlmNetInputPort      VINITHI_CPU3;
    tlmNetInputPort      CFGEND_CPU3;
    tlmNetInputPort      TEINIT_CPU3;
    tlmNetInputPort      CFGNMFI_CPU3;
    ...
    arm_Cortex_A9MPx4(tlmModule &parent, sc_module_name name)
    ...
    , wdResetReq_CPU3(parent, this, "wdResetReq_CPU3")
    , wdReset_CPU3(parent, this, "wdReset_CPU3")
    , VINITHI_CPU3(parent, this, "VINITHI_CPU3")
    , CFGEND_CPU3(parent, this, "CFGEND_CPU3")
    , TEINIT_CPU3(parent, this, "TEINIT_CPU3")
    , CFGNMFI_CPU3(parent, this, "CFGNMFI_CPU3")
    ...
    arm_Cortex_A9MPx4(tlmModule &parent, sc_module_name name, params p, Uns32 INSTRUCTIONWidth=32, Uns32 DATAWidth=32, Uns32 GICRegistersWidth=32)
