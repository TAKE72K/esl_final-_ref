...
class arm_ARMv6K : public tlmProcessor
{
  private:
    params paramsForProc(params p) {
        p.set("variant", "ARMv6K");
        return p;
    }
  ...
  public:
    ...
    arm_ARMv6K(tlmModule &parent, sc_module_name name)
    ...
    arm_ARMv6K(tlmModule &parent, sc_module_name name, params p, Uns32 INSTRUCTIONWidth=32, Uns32 DATAWidth=32)
