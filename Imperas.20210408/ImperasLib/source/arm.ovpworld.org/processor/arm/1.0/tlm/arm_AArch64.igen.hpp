...
class arm_AArch64 : public tlmProcessor
{
  private:
    params paramsForProc(params p) {
        p.set("variant", "AArch64");
        return p;
    }
  ...
  public:
    ...
    arm_AArch64(tlmModule &parent, sc_module_name name)
    ...
    , RVBARADDRx(parent, this, "RVBARADDRx")
    ...
    arm_AArch64(tlmModule &parent, sc_module_name name, params p, Uns32 INSTRUCTIONWidth=44, Uns32 DATAWidth=44)
