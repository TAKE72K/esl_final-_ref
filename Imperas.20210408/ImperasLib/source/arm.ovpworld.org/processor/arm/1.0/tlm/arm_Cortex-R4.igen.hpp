...
class arm_Cortex_R4 : public tlmProcessor
{
  private:
    params paramsForProc(params p) {
        p.set("variant", "Cortex-R4");
        return p;
    }
  ...
  public:
    ...
    arm_Cortex_R4(tlmModule &parent, sc_module_name name)
    ...
    arm_Cortex_R4(tlmModule &parent, sc_module_name name, params p, Uns32 ATCM0Width=32, Uns32 BTCM0Width=32, Uns32 INSTRUCTIONWidth=32, Uns32 DATAWidth=32)
