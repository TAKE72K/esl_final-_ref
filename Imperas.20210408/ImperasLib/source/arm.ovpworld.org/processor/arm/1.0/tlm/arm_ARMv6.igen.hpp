...
class arm_ARMv6 : public tlmProcessor
{
  private:
  ...
  public:
    ...
    arm_ARMv6(tlmModule &parent, sc_module_name name)
    ...
    arm_ARMv6(tlmModule &parent, sc_module_name name, params p, Uns32 INSTRUCTIONWidth=32, Uns32 DATAWidth=32)
