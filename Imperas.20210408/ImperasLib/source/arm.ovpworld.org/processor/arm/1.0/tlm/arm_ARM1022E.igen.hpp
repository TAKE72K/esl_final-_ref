...
class arm_ARM1022E : public tlmProcessor
{
  private:
    params paramsForProc(params p) {
        p.set("variant", "ARM1022E");
        return p;
    }
  ...
  public:
    ...
    arm_ARM1022E(tlmModule &parent, sc_module_name name)
    ...
    arm_ARM1022E(tlmModule &parent, sc_module_name name, params p, Uns32 INSTRUCTIONWidth=32, Uns32 DATAWidth=32)
