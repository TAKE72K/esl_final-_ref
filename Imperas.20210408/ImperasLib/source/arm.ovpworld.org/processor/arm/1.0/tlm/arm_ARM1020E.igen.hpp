...
class arm_ARM1020E : public tlmProcessor
{
  private:
    params paramsForProc(params p) {
        p.set("variant", "ARM1020E");
        return p;
    }
  ...
  public:
    ...
    arm_ARM1020E(tlmModule &parent, sc_module_name name)
    ...
    arm_ARM1020E(tlmModule &parent, sc_module_name name, params p, Uns32 INSTRUCTIONWidth=32, Uns32 DATAWidth=32)
