...
class arm_Cortex_R4F : public tlmProcessor
{
  private:
    params paramsForProc(params p) {
        p.set("variant", "Cortex-R4F");
        return p;
    }
  ...
  public:
    tlmBusMasterPort     ATCM0;
    tlmBusMasterPort     BTCM0;
    tlmBusMasterPort     INSTRUCTION;
    tlmBusMasterPort     DATA;
    tlmNetInputPort      EVENTI;
    tlmNetOutputPort     EVENTO;
    tlmNetInputPort      VINITHI;
    tlmNetInputPort      CFGEE;
    tlmNetInputPort      CFGIE;
    tlmNetInputPort      INITRAMA;
    tlmNetInputPort      INITRAMB;
    tlmNetInputPort      LOCZRAMA;
    tlmNetInputPort      TEINIT;
    tlmNetInputPort      CFGNMFI;
    ...
    arm_Cortex_R4F(tlmModule &parent, sc_module_name name)
    : tlmProcessor(parent, getModel(), name, paramsForProc())
    , ATCM0 (parent, this, "ATCM0", 32)
    , BTCM0 (parent, this, "BTCM0", 32)
    ...
    , CFGEE(parent, this, "CFGEE")
    , CFGIE(parent, this, "CFGIE")
    , INITRAMA(parent, this, "INITRAMA")
    , INITRAMB(parent, this, "INITRAMB")
    , LOCZRAMA(parent, this, "LOCZRAMA")
    , TEINIT(parent, this, "TEINIT")
    , CFGNMFI(parent, this, "CFGNMFI")
    ...
    arm_Cortex_R4F(tlmModule &parent, sc_module_name name, params p, Uns32 ATCM0Width=32, Uns32 BTCM0Width=32, Uns32 INSTRUCTIONWidth=32, Uns32 DATAWidth=32)
    : tlmProcessor(parent, getModel(), name, paramsForProc(p))
    , ATCM0 (parent, this, "ATCM0", ATCM0Width)
    , BTCM0 (parent, this, "BTCM0", BTCM0Width)
