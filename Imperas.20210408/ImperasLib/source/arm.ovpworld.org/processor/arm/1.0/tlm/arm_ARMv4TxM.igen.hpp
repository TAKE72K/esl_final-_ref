...
class arm_ARMv4TxM : public tlmProcessor
{
  private:
    params paramsForProc(params p) {
        p.set("variant", "ARMv4TxM");
        return p;
    }
  ...
  public:
    ...
    arm_ARMv4TxM(tlmModule &parent, sc_module_name name)
    ...
    arm_ARMv4TxM(tlmModule &parent, sc_module_name name, params p, Uns32 INSTRUCTIONWidth=32, Uns32 DATAWidth=32)
