...
class arm_Cortex_A15MPx1 : public tlmProcessor
{
  private:
    params paramsForProc(params p) {
        p.set("variant", "Cortex-A15MPx1");
        return p;
    }
  ...
  public:
    ...
    arm_Cortex_A15MPx1(tlmModule &parent, sc_module_name name)
    ...
    arm_Cortex_A15MPx1(tlmModule &parent, sc_module_name name, params p, Uns32 INSTRUCTIONWidth=40, Uns32 DATAWidth=40, Uns32 GICRegistersWidth=32)
