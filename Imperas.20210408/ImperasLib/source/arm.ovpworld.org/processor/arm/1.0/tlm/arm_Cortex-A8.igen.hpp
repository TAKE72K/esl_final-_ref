...
class arm_Cortex_A8 : public tlmProcessor
{
  private:
    params paramsForProc(params p) {
        p.set("variant", "Cortex-A8");
        return p;
    }
  ...
  public:
    ...
    arm_Cortex_A8(tlmModule &parent, sc_module_name name)
    ...
    arm_Cortex_A8(tlmModule &parent, sc_module_name name, params p, Uns32 INSTRUCTIONWidth=32, Uns32 DATAWidth=32)
