...
class arm_Cortex_A9UP : public tlmProcessor
{
  private:
    params paramsForProc(params p) {
        p.set("variant", "Cortex-A9UP");
        return p;
    }
  ...
  public:
    ...
    arm_Cortex_A9UP(tlmModule &parent, sc_module_name name)
    ...
    arm_Cortex_A9UP(tlmModule &parent, sc_module_name name, params p, Uns32 INSTRUCTIONWidth=32, Uns32 DATAWidth=32)
