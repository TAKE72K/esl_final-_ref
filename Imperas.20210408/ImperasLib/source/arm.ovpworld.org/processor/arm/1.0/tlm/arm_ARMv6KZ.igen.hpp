...
class arm_ARMv6KZ : public tlmProcessor
{
  private:
    params paramsForProc(params p) {
        p.set("variant", "ARMv6KZ");
        return p;
    }
  ...
  public:
    ...
    arm_ARMv6KZ(tlmModule &parent, sc_module_name name)
    ...
    arm_ARMv6KZ(tlmModule &parent, sc_module_name name, params p, Uns32 INSTRUCTIONWidth=32, Uns32 DATAWidth=32)
