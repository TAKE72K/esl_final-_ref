...
// eg. if (diagnosticLevel >= 1) bhmMessage("I", "SMemCtrlPL354", "Example");
...
PPM_DOC_FN(installDocs){
    ...
    ppmDocNodeP Root1_node = ppmDocAddSection(0, "Root");
    {
        ...
        ppmDocAddText(doc2_node, "PL354 Static Memory Controller");
        ...
        ppmDocAddText(doc_22_node, "ARM PrimeCell Static Memory Controller (PL350 series) Technical Reference Manual (ARM DDI 0380)");
