...
#define BPORT1_AB_STATUSREG_POFFSET     0x0
#define BPORT1_AB_STATUSREG             (BPORT1 + BPORT1_AB_POFFSET + BPORT1_AB_STATUSREG_POFFSET)

#define BPORT1_AB_USERSTATUSREG_POFFSET  0x300
#define BPORT1_AB_USERSTATUSREG         (BPORT1 + BPORT1_AB_POFFSET + BPORT1_AB_USERSTATUSREG_POFFSET)
