...
static void cmdParserAddUserArgs(optCmdParserP parser) {
    ...
    opCmdParserAdd(parser, "linuxcmd", 0 , 0, "userPlatformConfig", OP_FT_STRINGVAL     , &options.linuxcmd, "Linux command line (default: 'mem=1024M raid=noautodetect console=ttyAMA0,38400n8 vmalloc=256MB devtmpfs.mount=0'", OP_AC_ALL, 0, 0);
