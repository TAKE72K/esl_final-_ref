...
// eg. if (diagnosticLevel >= 1) bhmMessage("I", "MaltaFPGA", "Example");
...
static void installSlavePorts(void) {
    handles.busPort1 = ppmCreateSlaveBusPort("busPort1", 2304);

    handles.busPort2 = ppmCreateSlaveBusPort("busPort2", 1536);
...
PPM_DOC_FN(installDocs){
    ...
    ppmDocNodeP Root1_node = ppmDocAddSection(0, "Root");
    {
        ...
        ppmDocAddText(doc_12_node, "MIPS MALTA FPGA. Drives Development board functions.");
        ...
        ppmDocAddText(doc_32_node, "MIPS Malta User Manual.");
    }
}
////////////////////////////////// Constructor /////////////////////////////////
