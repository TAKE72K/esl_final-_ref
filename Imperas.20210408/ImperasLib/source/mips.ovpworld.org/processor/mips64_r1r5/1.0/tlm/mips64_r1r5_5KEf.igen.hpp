...
class mips64_r1r5_5KEf : public tlmProcessor
{
  private:
  ...
  public:
    ...
    mips64_r1r5_5KEf(tlmModule &parent, sc_module_name name)
    ...
    mips64_r1r5_5KEf(tlmModule &parent, sc_module_name name, params p, Uns32 INSTRUCTIONWidth=32, Uns32 DATAWidth=32)
