...
class mips64_r1r5 : public tlmProcessor
{
  private:
  ...
  public:
    ...
    mips64_r1r5(tlmModule &parent, sc_module_name name)
    ...
    mips64_r1r5(tlmModule &parent, sc_module_name name, params p, Uns32 INSTRUCTIONWidth=32, Uns32 DATAWidth=32)
