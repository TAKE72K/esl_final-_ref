...
class mips32_r1r5_4KEp : public tlmProcessor
{
  private:
  ...
  public:
    ...
    mips32_r1r5_4KEp(tlmModule &parent, sc_module_name name)
    ...
    mips32_r1r5_4KEp(tlmModule &parent, sc_module_name name, params p, Uns32 INSTRUCTIONWidth=32, Uns32 DATAWidth=32)
