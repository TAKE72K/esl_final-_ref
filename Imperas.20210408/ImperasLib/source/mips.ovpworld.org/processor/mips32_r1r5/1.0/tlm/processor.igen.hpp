...
class mips32_r1r5 : public tlmProcessor
{
  private:
  ...
  public:
    ...
    mips32_r1r5(tlmModule &parent, sc_module_name name)
    ...
    mips32_r1r5(tlmModule &parent, sc_module_name name, params p, Uns32 INSTRUCTIONWidth=32, Uns32 DATAWidth=32)
