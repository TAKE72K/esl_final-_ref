...
class mips32_r1r5_microAptivP : public tlmProcessor
{
  private:
    params paramsForProc(params p) {
        p.set("variant", "microAptivP");
        return p;
    }
  ...
  public:
    ...
    mips32_r1r5_microAptivP(tlmModule &parent, sc_module_name name)
    ...
    mips32_r1r5_microAptivP(tlmModule &parent, sc_module_name name, params p, Uns32 INSTRUCTIONWidth=32, Uns32 DATAWidth=32)
