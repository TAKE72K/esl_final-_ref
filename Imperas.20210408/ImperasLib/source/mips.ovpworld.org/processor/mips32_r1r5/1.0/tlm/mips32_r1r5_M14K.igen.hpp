...
class mips32_r1r5_M14K : public tlmProcessor
{
  private:
  ...
  public:
    ...
    mips32_r1r5_M14K(tlmModule &parent, sc_module_name name)
    ...
    mips32_r1r5_M14K(tlmModule &parent, sc_module_name name, params p, Uns32 INSTRUCTIONWidth=32, Uns32 DATAWidth=32)
