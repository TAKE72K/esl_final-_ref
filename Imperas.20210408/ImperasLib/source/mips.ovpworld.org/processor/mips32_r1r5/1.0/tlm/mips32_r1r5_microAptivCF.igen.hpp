...
class mips32_r1r5_microAptivCF : public tlmProcessor
{
  private:
    params paramsForProc(params p) {
        p.set("variant", "microAptivCF");
        return p;
    }
  ...
  public:
    ...
    mips32_r1r5_microAptivCF(tlmModule &parent, sc_module_name name)
    ...
    mips32_r1r5_microAptivCF(tlmModule &parent, sc_module_name name, params p, Uns32 INSTRUCTIONWidth=32, Uns32 DATAWidth=32)
...
}; /* class mips32_r1r5_microAptivCF */
