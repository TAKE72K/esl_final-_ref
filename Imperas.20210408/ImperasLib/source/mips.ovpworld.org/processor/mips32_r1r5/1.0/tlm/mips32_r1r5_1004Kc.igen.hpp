...
class mips32_r1r5_1004Kc : public tlmProcessor
{
  private:
    params paramsForProc(params p) {
        p.set("variant", "1004Kc");
        return p;
    }
  ...
  public:
    ...
    mips32_r1r5_1004Kc(tlmModule &parent, sc_module_name name)
    ...
    mips32_r1r5_1004Kc(tlmModule &parent, sc_module_name name, params p, Uns32 INSTRUCTIONWidth=32, Uns32 DATAWidth=32)
