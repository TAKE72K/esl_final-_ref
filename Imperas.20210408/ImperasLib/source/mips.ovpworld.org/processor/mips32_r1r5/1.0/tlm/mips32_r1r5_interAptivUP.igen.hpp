...
class mips32_r1r5_interAptivUP : public tlmProcessor
{
  private:
    params paramsForProc(params p) {
        p.set("variant", "interAptivUP");
        return p;
    }
  ...
  public:
    ...
    tlmNetInputPort      SI_EVAReset;
    tlmNetInputPort      SI_ExceptionBasePA;
    tlmNetInputPort      SI_ExceptionBaseMask;
    ...
    mips32_r1r5_interAptivUP(tlmModule &parent, sc_module_name name)
    ...
    , SI_EVAReset(parent, this, "SI_EVAReset")
    , SI_ExceptionBasePA(parent, this, "SI_ExceptionBasePA")
    , SI_ExceptionBaseMask(parent, this, "SI_ExceptionBaseMask")
    ...
    mips32_r1r5_interAptivUP(tlmModule &parent, sc_module_name name, params p, Uns32 INSTRUCTIONWidth=32, Uns32 DATAWidth=32)
...
}; /* class mips32_r1r5_interAptivUP */
