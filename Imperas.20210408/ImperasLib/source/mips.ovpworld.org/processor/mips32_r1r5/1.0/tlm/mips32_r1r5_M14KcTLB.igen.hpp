...
class mips32_r1r5_M14KcTLB : public tlmProcessor
{
  private:
    params paramsForProc(params p) {
        p.set("variant", "M14KcTLB");
        return p;
    }
  ...
  public:
    ...
    mips32_r1r5_M14KcTLB(tlmModule &parent, sc_module_name name)
    ...
    mips32_r1r5_M14KcTLB(tlmModule &parent, sc_module_name name, params p, Uns32 INSTRUCTIONWidth=32, Uns32 DATAWidth=32)
