...
class mips32_r1r5_microAptivC : public tlmProcessor
{
  private:
    params paramsForProc(params p) {
        p.set("variant", "microAptivC");
        return p;
    }
  ...
  public:
    ...
    mips32_r1r5_microAptivC(tlmModule &parent, sc_module_name name)
    ...
    mips32_r1r5_microAptivC(tlmModule &parent, sc_module_name name, params p, Uns32 INSTRUCTIONWidth=32, Uns32 DATAWidth=32)
