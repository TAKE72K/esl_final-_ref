...
class mips32_r1r5_proAptiv : public tlmProcessor
{
  private:
    params paramsForProc(params p) {
        p.set("variant", "proAptiv");
        return p;
    }
  ...
  public:
    ...
    mips32_r1r5_proAptiv(tlmModule &parent, sc_module_name name)
    ...
    mips32_r1r5_proAptiv(tlmModule &parent, sc_module_name name, params p, Uns32 INSTRUCTIONWidth=32, Uns32 DATAWidth=32)
