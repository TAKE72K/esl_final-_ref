...
class mips32_M6250 : public tlmProcessor
{
  private:
  ...
  public:
    ...
    mips32_M6250(tlmModule &parent, sc_module_name name)
    ...
    mips32_M6250(tlmModule &parent, sc_module_name name, params p, Uns32 ISPRAMWidth=32, Uns32 DSPRAMWidth=32, Uns32 INSTRUCTIONWidth=32, Uns32 DATAWidth=32)
