...
class mips32_P5600 : public tlmProcessor
{
  private:
  ...
  public:
    ...
    mips32_P5600(tlmModule &parent, sc_module_name name)
    ...
    mips32_P5600(tlmModule &parent, sc_module_name name, params p, Uns32 INSTRUCTIONWidth=32, Uns32 DATAWidth=32, Uns32 USPRAMWidth=32)
