...
class mips32 : public tlmProcessor
{
  private:
  ...
  public:
    ...
    mips32(tlmModule &parent, sc_module_name name)
    ...
    mips32(tlmModule &parent, sc_module_name name, params p, Uns32 INSTRUCTIONWidth=32, Uns32 DATAWidth=32, Uns32 USPRAMWidth=32)
