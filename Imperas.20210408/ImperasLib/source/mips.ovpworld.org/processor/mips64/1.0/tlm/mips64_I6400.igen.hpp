...
class mips64_I6400 : public tlmProcessor
{
  private:
  ...
  public:
    ...
    mips64_I6400(tlmModule &parent, sc_module_name name)
    ...
    mips64_I6400(tlmModule &parent, sc_module_name name, params p, Uns32 INSTRUCTIONWidth=32, Uns32 DATAWidth=32)
