...
int main(int argc, const char *argv[])
{
    ...
    const char *mipsModel    = opVLNVString(NULL, "mips.ovpworld.org", "processor", "mips32_r1r5", "1.0", OP_PROCESSOR, 0);
    ...
    paramsCpu0 = opParamEnumSet(paramsCpu0, "variant", "74Kc");
    ...
    paramsCpu1 = opParamEnumSet(paramsCpu1, "variant", "74Kc");
...
static Bool cmdParser(int argc, const char *argv[]) {
    ...
    const char *message = "Basic Usage\n"
...
static void addPlatformDocumentation() {
    ...
    optDocNodeP Root1_node = opDocSectionAdd(0, "Root");
    {
        ...
        opDocTextAdd(doc_12_node, "Bare Metal Platform for a MIPS32 Processor (default 74Kc)."
