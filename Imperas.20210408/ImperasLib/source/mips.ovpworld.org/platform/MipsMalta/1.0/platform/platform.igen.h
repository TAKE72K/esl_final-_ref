...
////////////////////////////////////////////////////////////////////////////////
    ...
    opProcessorNew(
        ...
        OP_PARAMS(
            ...
            ,OP_PARAM_ENUM_SET("variant", "24KEf")
    ...
    const char *pciBrD_path = opVLNVString(
        0, // use the default VLNV path
        "ovpworld.org",
        0,
        "DynamicBridge",
    ...
    opPeripheralNew(
        ...
        OP_PARAMS(
             OP_PARAM_UNS64_SET("spLoAddress", 0x18000000ULL)
            ,OP_PARAM_UNS64_SET("mpLoAddress", 0x0ULL)
            ,OP_PARAM_UNS64_SET("portSize", 0x4ffULL)
    ...
    opPeripheralNew(
        ...
        OP_CONNECTIONS(
            OP_BUS_CONNECTIONS(
                ...
                OP_BUS_CONNECT(busPCIReMap_b, "io", .slave=1, .addrLo=0x20ULL, .addrHi=0x21ULL),
                OP_BUS_CONNECT(busPCIReMap_b, "elcr", .slave=1, .addrLo=0x4d0ULL, .addrHi=0x4d0ULL),
    ...
    opPeripheralNew(
        ...
        OP_CONNECTIONS(
            OP_BUS_CONNECTIONS(
                OP_BUS_CONNECT(busPCIReMap_b, "io", .slave=1, .addrLo=0xa0ULL, .addrHi=0xa1ULL),
                OP_BUS_CONNECT(busPCIReMap_b, "elcr", .slave=1, .addrLo=0x4d1ULL, .addrHi=0x4d1ULL),
    ...
    opPeripheralNew(
        ...
        OP_CONNECTIONS(
            OP_BUS_CONNECTIONS(
                OP_BUS_CONNECT(busPCIReMap_b, "bport1", .slave=1, .addrLo=0xb0ULL, .addrHi=0xb3ULL)
            )
        ),
        0
    );
    ...
    opPeripheralNew(
        ...
        OP_CONNECTIONS(
            OP_BUS_CONNECTIONS(
                OP_BUS_CONNECT(PCIconfigBus_b, "PCIconfig", .slave=1, .dynamic=1),
                OP_BUS_CONNECT(busPCIReMap_b, "config", .slave=1, .addrLo=0x3b0ULL, .addrHi=0x3dfULL),
    ...
    opPeripheralNew(
        ...
        OP_CONNECTIONS(
            OP_BUS_CONNECTIONS(
                OP_BUS_CONNECT(busPCIReMap_b, "config", .slave=1, .addrLo=0x60ULL, .addrHi=0x67ULL)
            ),
            OP_NET_CONNECTIONS(
    ...
    opPeripheralNew(
        ...
        OP_CONNECTIONS(
            OP_BUS_CONNECTIONS(
                OP_BUS_CONNECT(busPCIReMap_b, "bport1", .slave=1, .addrLo=0x40ULL, .addrHi=0x43ULL)
            )
        ),
        0
    );
    ...
    opPeripheralNew(
        ...
        OP_CONNECTIONS(
            OP_BUS_CONNECTIONS(
                OP_BUS_CONNECT(busPCIReMap_b, "busPort", .slave=1, .addrLo=0x70ULL, .addrHi=0x71ULL)
            ),
            OP_NET_CONNECTIONS(
    ...
    opPeripheralNew(
        ...
        OP_CONNECTIONS(
            OP_BUS_CONNECTIONS(
                OP_BUS_CONNECT(busPCIReMap_b, "bport1", .slave=1, .addrLo=0x3f8ULL, .addrHi=0x3ffULL)
            ),
            OP_NET_CONNECTIONS(
    ...
    opPeripheralNew(
        ...
        OP_CONNECTIONS(
            OP_BUS_CONNECTIONS(
                OP_BUS_CONNECT(busPCIReMap_b, "bport1", .slave=1, .addrLo=0x2f8ULL, .addrHi=0x2ffULL)
            ),
            OP_NET_CONNECTIONS(
    ...
    opPeripheralNew(
        ...
        OP_CONNECTIONS(
            OP_BUS_CONNECTIONS(
                OP_BUS_CONNECT(busPCIReMap_b, "bport1", .slave=1, .addrLo=0x3f0ULL, .addrHi=0x3f7ULL)
            )
        ),
        0
    );
    ...
    opPeripheralNew(
        ...
        OP_CONNECTIONS(
            OP_BUS_CONNECTIONS(
                OP_BUS_CONNECT(busPCIReMap_b, "busPort", .slave=1, .addrLo=0x100ULL, .addrHi=0x103ULL)
            )
        ),
        0
    );
...
static void cmdParserAddUserArgs(optCmdParserP parser) {
    opCmdParserAdd(parser, "kernel"  , 0 , 0, "user platform config Linux", OP_FT_STRINGVAL     , &options.kernel, "The Linux Kernel image e.g. vmlinux", OP_AC_ALL, 0, 0);
    opCmdParserAdd(parser, "ramdisk" , 0 , 0, "user platform config Linux", OP_FT_STRINGVAL     , &options.ramdisk, "Boot Linux Kernel from the specified ramdisk image e.g. initrd.gz", OP_AC_ALL, 0, 0);
    opCmdParserAdd(parser, "disk"    , 0 , 0, "user platform config Linux", OP_FT_STRINGVAL     , &options.disk, "Boot Linux Kernel from the root partition on the disk image e.g. mipsle_hda1", OP_AC_ALL, 0, 0);
    opCmdParserAdd(parser, "root"    , 0 , 0, "user platform config Linux", OP_FT_STRINGVAL     , &options.root, "Specify the root partition on the disk image e.g. /dev/sda1", OP_AC_ALL, 0, 0);
    opCmdParserAdd(parser, "pagebits", 0 , 0, "user platform config Linux", OP_FT_UNS64VAL      , &options.pagebits, "Specify the page bits used by a Linux Kernel", OP_AC_ALL, 0, 0);
    opCmdParserAdd(parser, "console" , 0 , 0, "user platform config Linux", OP_FT_STRINGVAL     , &options.console, "Specify the command line console entry of the Linux Kernel command line, for example tty0", OP_AC_ALL, 0, 0);
    opCmdParserAdd(parser, "finishonhalt", 0 , 0, "user platform config", OP_FT_BOOLVAL       , &options.finishonhalt, "Finish simulation when Malta Soft reset asserted", OP_AC_ALL, 0, 0);
    opCmdParserAdd(parser, "redir"   , 0 , 0, "user platform config", OP_FT_BOOLVAL       , &options.redir, "Enable re-direction of IP address", OP_AC_ALL, 0, 0);
    opCmdParserAdd(parser, "nographics", 0 , 0, "user platform config", OP_FT_BOOLVAL       , &options.nographics, "Disable the VGA graphics window.", OP_AC_ALL, 0, 0);
    opCmdParserAdd(parser, "tftproot", 0 , 0, "user platform config", OP_FT_STRINGVAL     , &options.tftproot, "Enable TFTP and specify the tftp root on the host machine.", OP_AC_ALL, 0, 0);
    opCmdParserAdd(parser, "bootimage", 0 , 0, "user platform config", OP_FT_STRINGVAL     , &options.bootimage, "Specify a boot image to use. This replaces the default image generated by the SmartLoader.", OP_AC_ALL, 0, 0);
}
