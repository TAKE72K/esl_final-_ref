...
class m16c_m16c : public tlmProcessor
{
  private:
  ...
  public:
    ...
    m16c_m16c(tlmModule &parent, sc_module_name name)
    ...
    m16c_m16c(tlmModule &parent, sc_module_name name, params p, Uns32 INSTRUCTIONWidth=32, Uns32 DATAWidth=32)
