...
#imodeladdformal -name board -type enum -defaultvalue ZC706
#iadddocumentation -name Description -text "The XADC interface includes default data values, access is board dependent so must be configured (ZC706 or ZC702)"
#imodeladdenumeration -formal board -name ZC706
#imodeladdenumeration -formal board -name ZC702
