...
typedef struct plb_REG_dataS { 
    ...
    union { 
        Uns32 value;
        struct {
            Uns32 RxFifoValidData : 1;
            Uns32 RxFifoFull : 1;
            Uns32 TxFifoEmpty : 1;
            Uns32 TxFifoFull : 1;
            Uns32 IntrEnabled : 1;
            Uns32 OverrunError : 1;
            Uns32 FrameError : 1;
            Uns32 ParityError : 1;
        } bits;
    } Stat;
...
#define PLB_REG_RXFIFO_WIDTH            32
#define PLB_REG_TXFIFO_WIDTH            32
#define PLB_REG_STAT_WIDTH              32
#define PLB_REG_CTRL_WIDTH              32
