...
class microblaze : public tlmProcessor
{
  private:
  ...
  public:
    ...
    microblaze(tlmModule &parent, sc_module_name name)
    ...
    microblaze(tlmModule &parent, sc_module_name name, params p, Uns32 INSTRUCTIONWidth=32, Uns32 DATAWidth=32)
