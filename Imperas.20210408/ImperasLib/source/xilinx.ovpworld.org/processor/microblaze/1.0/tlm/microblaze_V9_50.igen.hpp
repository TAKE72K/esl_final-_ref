...
class microblaze_V9_50 : public tlmProcessor
{
  private:
  ...
  public:
    ...
    microblaze_V9_50(tlmModule &parent, sc_module_name name)
    ...
    microblaze_V9_50(tlmModule &parent, sc_module_name name, params p, Uns32 INSTRUCTIONWidth=32, Uns32 DATAWidth=32)
