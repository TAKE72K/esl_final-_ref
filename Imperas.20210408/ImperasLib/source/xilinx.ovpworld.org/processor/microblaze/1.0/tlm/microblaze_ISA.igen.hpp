...
class microblaze_ISA : public tlmProcessor
{
  private:
  ...
  public:
    ...
    microblaze_ISA(tlmModule &parent, sc_module_name name)
    ...
    microblaze_ISA(tlmModule &parent, sc_module_name name, params p, Uns32 INSTRUCTIONWidth=32, Uns32 DATAWidth=32)
