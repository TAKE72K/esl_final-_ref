...
class microblaze_V7_10 : public tlmProcessor
{
  private:
  ...
  public:
    ...
    microblaze_V7_10(tlmModule &parent, sc_module_name name)
    ...
    microblaze_V7_10(tlmModule &parent, sc_module_name name, params p, Uns32 INSTRUCTIONWidth=32, Uns32 DATAWidth=32)
