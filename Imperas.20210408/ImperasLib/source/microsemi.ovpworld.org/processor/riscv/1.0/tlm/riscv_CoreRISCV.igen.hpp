...
class riscv_CoreRISCV : public tlmProcessor
{
  private:
    params paramsForProc(params p) {
        p.set("variant", "CoreRISCV");
        return p;
    }
  ...
  public:
    ...
    riscv_CoreRISCV(tlmModule &parent, sc_module_name name)
    ...
    riscv_CoreRISCV(tlmModule &parent, sc_module_name name, params p, Uns32 INSTRUCTIONWidth=34, Uns32 DATAWidth=34)
