...
class arc_600 : public tlmProcessor
{
  private:
  ...
  public:
    ...
    arc_600(tlmModule &parent, sc_module_name name)
    ...
    arc_600(tlmModule &parent, sc_module_name name, params p, Uns32 INSTRUCTIONWidth=32, Uns32 DATAWidth=32)
