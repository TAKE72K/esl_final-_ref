...
class arc : public tlmProcessor
{
  ...
  public:
    ...
    arc(tlmModule &parent, sc_module_name name)
    ...
    arc(tlmModule &parent, sc_module_name name, params p, Uns32 INSTRUCTIONWidth=32, Uns32 DATAWidth=32)
