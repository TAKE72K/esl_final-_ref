...
class arc_700 : public tlmProcessor
{
  private:
  ...
  public:
    ...
    arc_700(tlmModule &parent, sc_module_name name)
    ...
    arc_700(tlmModule &parent, sc_module_name name, params p, Uns32 INSTRUCTIONWidth=32, Uns32 DATAWidth=32)
