...
// eg. if (diagnosticLevel >= 1) bhmMessage("I", "KinetisRFVBAT", "Example");
...
PPM_DOC_FN(installDocs){
    ...
    ppmDocNodeP Root1_node = ppmDocAddSection(0, "Root");
    {
        ...
        ppmDocAddText(doc2_node, "Model of the RFVBAT peripheral used on the Freescale Kinetis platform");
