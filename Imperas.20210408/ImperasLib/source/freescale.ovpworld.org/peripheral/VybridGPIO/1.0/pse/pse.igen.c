...
static PPM_WRITE_CB(bport1_ab_PDOR_maskWrite) {
    bport1_ab_data.PDOR.value = (bport1_ab_data.PDOR.value & BPORT1_AB_PDOR_WRNMASK) | (data & BPORT1_AB_PDOR_WRMASK);
}
...
PPM_NET_CB(reset_Reset) {
    if(value != 0 ) {
        bport1_ab_data.PDIR.value = (Uns32)(bport1_ab_data.PDIR.value & ~(0xffffffff)) | ((0xffffffff) & (0x0));
        bport1_ab_data.PTOR.value = (Uns32)(bport1_ab_data.PTOR.value & ~(0xffffffff)) | ((0xffffffff) & (0x0));
        bport1_ab_data.PCOR.value = (Uns32)(bport1_ab_data.PCOR.value & ~(0xffffffff)) | ((0xffffffff) & (0x0));
        bport1_ab_data.PSOR.value = (Uns32)(bport1_ab_data.PSOR.value & ~(0xffffffff)) | ((0xffffffff) & (0x0));
        bport1_ab_data.PDOR.value = (Uns32)(bport1_ab_data.PDOR.value & ~(0xffffffff)) | ((0xffffffff) & (0x0));
    }
}
...
PPM_DOC_FN(installDocs){
    ...
    ppmDocNodeP Root1_node = ppmDocAddSection(0, "Root");
    {
        ...
        ppmDocAddText(doc2_node, "Model of the GPIO peripheral used on the Freescale Vybrid platform");
