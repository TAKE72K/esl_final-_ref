...
// eg. if (diagnosticLevel >= 1) bhmMessage("I", "VybridSPI", "Example");
...
static PPM_WRITE_CB(bport1_ab_CTAR_maskWrite) {
    bport1_ab_data.CTAR.value = (bport1_ab_data.CTAR.value & BPORT1_AB_CTAR_WRNMASK) | (data & BPORT1_AB_CTAR_WRMASK);
}
...
static void installRegisters(void) {

    {
        ...
        ppmCreateRegisterField(abMCR_reg, "FCPCS", 0, 2, 1, 1, 1);
        ...
        ppmCreateRegisterField(abMCR_reg, "PES", 0, 1, 1, 1, 1);
    ...
    {
        registerHandle abCTAR_reg = ppmCreateRegister(
            "ab_CTAR",
            ...
            4,
            read_32,
            bport1_ab_CTAR_maskWrite,
            view32,
            &(bport1_ab_data.CTAR.value),
            True
        );

        ppmCreateRegisterField(abCTAR_reg, "ASC", 0, 8, 4, 1, 1);
        ppmCreateRegisterField(abCTAR_reg, "BR", 0, 0, 4, 1, 1);
        ppmCreateRegisterField(abCTAR_reg, "CPHA", 0, 25, 1, 1, 1);
        ppmCreateRegisterField(abCTAR_reg, "CPOL", 0, 26, 1, 1, 1);
        ppmCreateRegisterField(abCTAR_reg, "CSSCK", 0, 12, 4, 1, 1);
        ppmCreateRegisterField(abCTAR_reg, "DBR", 0, 31, 1, 1, 1);
        ppmCreateRegisterField(abCTAR_reg, "DT", 0, 4, 4, 1, 1);
        ppmCreateRegisterField(abCTAR_reg, "FMSZ", 0, 27, 4, 1, 1);
        ppmCreateRegisterField(abCTAR_reg, "LSBFE", 0, 24, 1, 1, 1);
        ppmCreateRegisterField(abCTAR_reg, "PASC", 0, 20, 2, 1, 1);
        ppmCreateRegisterField(abCTAR_reg, "PBR", 0, 16, 2, 1, 1);
        ppmCreateRegisterField(abCTAR_reg, "PCSSCK", 0, 22, 2, 1, 1);
        ppmCreateRegisterField(abCTAR_reg, "PDT", 0, 18, 2, 1, 1);
    }
    {
        ...
        ppmCreateRegisterField(abSR_reg, "SPEF", 0, 21, 1, 1, 1);
    ...
    }
    {
        ...
        ppmCreateRegisterField(abRSER_reg, "SPEF_RE", 0, 21, 1, 1, 1);
    ...
    }
    {
        ...
        ppmCreateRegisterField(abPUSHR_reg, "PE_MASC", 0, 25, 1, 1, 1);
        ppmCreateRegisterField(abPUSHR_reg, "PP_MCSC", 0, 24, 1, 1, 1);
    ...
    {
        registerHandle abTXFR_reg = ppmCreateRegister(
            "ab_TXFR",
            ...
            0,
            view32,
            &(bport1_ab_data.TXFR.value),
            True
        );

        ppmCreateRegisterField(abTXFR_reg, "TXCMD_TXDATA", 0, 16, 16, 1, 0);
        ppmCreateRegisterField(abTXFR_reg, "TXDATA", 0, 0, 16, 1, 0);
    }
    {
        registerHandle abRXFR_reg = ppmCreateRegister(
            "ab_RXFR",
            ...
            0,
            view32,
            &(bport1_ab_data.RXFR.value),
            True
        );

        ppmCreateRegisterField(abRXFR_reg, "RXDATA", 0, 0, 32, 1, 0);
    }
...
PPM_NET_CB(reset_Reset) {
    if(value != 0 ) {
        bport1_ab_data.RXFR.value = (Uns32)(bport1_ab_data.RXFR.value & ~(0xffffffff)) | ((0xffffffff) & (0x00000000));
        bport1_ab_data.TXFR.value = (Uns32)(bport1_ab_data.TXFR.value & ~(0xffffffff)) | ((0xffffffff) & (0x00000000));
        ...
        bport1_ab_data.SR.value = (Uns32)(bport1_ab_data.SR.value & ~(0xffffffff)) | ((0xffffffff) & (0x02010000));
        bport1_ab_data.CTAR.value = (Uns32)(bport1_ab_data.CTAR.value & ~(0xffffffff)) | ((0xffffffff) & (0x78000000));
        bport1_ab_data.TCR.value = (Uns32)(bport1_ab_data.TCR.value & ~(0xffffffff)) | ((0xffffffff) & (0x00000000));
        bport1_ab_data.MCR.value = (Uns32)(bport1_ab_data.MCR.value & ~(0xffffffff)) | ((0xffffffff) & (0x00000001));
    }
}
...
PPM_DOC_FN(installDocs){
    ...
    ppmDocNodeP Root1_node = ppmDocAddSection(0, "Root");
    {
        ...
        ppmDocAddText(doc2_node, "Model of the SPI peripheral used on the Freescale Vybrid platform");
