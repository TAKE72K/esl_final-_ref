...
#define BPORT1_AB_C6_WRMASK             0xf0
#define BPORT1_AB_C6_WRNMASK            (0xf)
#define BPORT1_AB_C6_WIDTH              8
#define BPORT1_AB_PCTH_WRMASK           0xff
#define BPORT1_AB_PCTH_WRNMASK          (0x0)
#define BPORT1_AB_PCTH_WIDTH            8
#define BPORT1_AB_PCTL_WRMASK           0xff
#define BPORT1_AB_PCTL_WRNMASK          (0x0)
#define BPORT1_AB_PCTL_WIDTH            8
#define BPORT1_AB_B1T_WRMASK            0xff
#define BPORT1_AB_B1T_WRNMASK           (0x0)
#define BPORT1_AB_B1T_WIDTH             8
#define BPORT1_AB_SDTH_WRMASK           0xff
#define BPORT1_AB_SDTH_WRNMASK          (0x0)
#define BPORT1_AB_SDTH_WIDTH            8
#define BPORT1_AB_SDTL_WRMASK           0xff
#define BPORT1_AB_SDTL_WRNMASK          (0x0)
#define BPORT1_AB_SDTL_WIDTH            8
#define BPORT1_AB_PRE_WRMASK            0xff
#define BPORT1_AB_PRE_WRNMASK           (0x0)
#define BPORT1_AB_PRE_WIDTH             8
#define BPORT1_AB_TPL_WRMASK            0xff
#define BPORT1_AB_TPL_WRNMASK           (0x0)
#define BPORT1_AB_TPL_WIDTH             8
#define BPORT1_AB_IE_WRMASK             0x7f
#define BPORT1_AB_IE_WRNMASK            (0x80)
#define BPORT1_AB_IE_WIDTH              8
#define BPORT1_AB_WB_WRMASK             0xff
#define BPORT1_AB_WB_WRNMASK            (0x0)
#define BPORT1_AB_WB_WIDTH              8
#define BPORT1_AB_S3_WRMASK             0xdf
#define BPORT1_AB_S3_WRNMASK            (0x20)
#define BPORT1_AB_S3_WIDTH              8
#define BPORT1_AB_S4_WRMASK             0xf
#define BPORT1_AB_S4_WRNMASK            (0xf0)
#define BPORT1_AB_S4_WIDTH              8
#define BPORT1_AB_RPL_WIDTH             8
#define BPORT1_AB_RPREL_WIDTH           8
#define BPORT1_AB_CPW_WRMASK            0xff
#define BPORT1_AB_CPW_WRNMASK           (0x0)
#define BPORT1_AB_CPW_WIDTH             8
#define BPORT1_AB_RIDT_WRMASK           0xff
#define BPORT1_AB_RIDT_WRNMASK          (0x0)
#define BPORT1_AB_RIDT_WIDTH            8
#define BPORT1_AB_TIDT_WRMASK           0xff
#define BPORT1_AB_TIDT_WRNMASK          (0x0)
#define BPORT1_AB_TIDT_WIDTH            8
