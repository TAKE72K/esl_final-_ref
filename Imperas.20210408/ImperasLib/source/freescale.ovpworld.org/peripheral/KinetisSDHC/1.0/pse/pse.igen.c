...
static void installRegisters(void) {
    ...
    }
    {
        ...
        ppmCreateRegisterField(abHTCAPBLT_reg, "VS18", 0, 26, 1, 1, 0);
        ppmCreateRegisterField(abHTCAPBLT_reg, "VS30", 0, 25, 1, 1, 0);
    ...
    }
    {
        ...
        ppmCreateRegisterField(abVENDOR_reg, "EXTDMAEN", 0, 0, 1, 1, 1);
...
PPM_NET_CB(reset_Reset) {
    if(value != 0 ) {
        ...
        bport1_ab_data.WML.value = (Uns32)(bport1_ab_data.WML.value & ~(0xffffffff)) | ((0xffffffff) & (0x00100010));
...
PPM_DOC_FN(installDocs){
    ...
    ppmDocNodeP Root1_node = ppmDocAddSection(0, "Root");
    {
        ...
        ppmDocAddText(doc2_node, "Model of the SDHC peripheral used on the Freescale Kinetis platform");
