...
static OP_CONSTRUCT_FN(instantiateComponents) {
    ...
    opDocTextAdd(doc_31_node, "SafePower project Public Demonstrator");
    ...
    opModuleNew(
        ...
        OP_PARAMS(
            ...
            ,OP_PARAM_STRING_SET("board", "PublicDemonstrator")
        )
    );
