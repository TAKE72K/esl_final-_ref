...
// eg. if (diagnosticLevel >= 1) bhmMessage("I", "MC146818", "Example");
...
static void installSlavePorts(void) {
    handles.busPort = ppmCreateSlaveBusPort("busPort", 2);
    if (!handles.busPort) {
...
PPM_DOC_FN(installDocs){
    ...
    ppmDocNodeP Root1_node = ppmDocAddSection(0, "Root");
    {
        ...
        ppmDocAddText(doc_12_node, "MC146818 Real:time clock.");
        ...
        ppmDocAddText(doc_32_node, "Motorola MC146818AS Datasheet");
    }
}
////////////////////////////////// Constructor /////////////////////////////////
