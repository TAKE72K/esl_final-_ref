...
# GPIO connections
imodeladdnetport -type input  -name gpioin -updatefunction gpioinCB
imodeladdnetport -type output -name gpioout

# Simulation artifact (Switch and Button connections to visualisation using GPIO peripheral)
for {set i 0} {$i < 4} {incr i} {
  imodeladdnetport -type output -name intSW${i}
  imodeladdnetport -type output -name intBTN${i}
}
