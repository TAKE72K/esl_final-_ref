...
////////////////////////////////////////////////////////////////////////////////
    ...
    opMemoryNew(
        ...
        "flash",
        OP_PRIV_RX,
        (0x005fffffffULL) - (0x0040000000ULL),
        OP_CONNECTIONS(
            OP_BUS_CONNECTIONS(
                OP_BUS_CONNECT(systemBus_b, "sp1", .slave=1, .addrLo=0x0040000000ULL, .addrHi=0x005fffffffULL)
            )
        ),
        0
    );
    ...
    opPeripheralNew(
        ...
        OP_CONNECTIONS(
            ...
            OP_NET_CONNECTIONS(
                ...
                OP_NET_CONNECT(li0_n, "intSW0"),
                OP_NET_CONNECT(li1_n, "intSW1"),
                OP_NET_CONNECT(li2_n, "intSW2"),
                OP_NET_CONNECT(li3_n, "intSW3"),
                OP_NET_CONNECT(li4_n, "intBTN0"),
                OP_NET_CONNECT(li5_n, "intBTN1"),
                OP_NET_CONNECT(li6_n, "intBTN2"),
                OP_NET_CONNECT(li7_n, "intBTN3")
            )
        ),
        0
    );
