...
static OP_CONSTRUCT_FN(instantiateComponents) {
    ...
    opDocTextAdd(doc_31_node, "The Serial Peripheral Interface (SPI) is not modeled. Instead a Virtio Block MMIO device has been added at reserved address 0x1f000000, using interrupt 54.");
    opDocTextAdd(doc_31_node, "The General Purpose Input/Output Controller (GPIO) is not modeled.");
    opDocTextAdd(doc_31_node, "The One-Time Programmable Memory Interface (OTP) is not modeled.");
    opDocTextAdd(doc_31_node, "DDR controller is not modeled. DDR memory is modeled as RAM.");
...
////////////////////////////////////////////////////////////////////////////////
    ...
    opPeripheralNew(
        ...
        OP_PARAMS(
            ...
            ,OP_PARAM_UNS64_SET("slbootaddr", 0x10000ULL)
