...
class riscv_U54 : public tlmProcessor
{
  private:
  ...
  public:
    ...
    riscv_U54(tlmModule &parent, sc_module_name name)
    ...
    riscv_U54(tlmModule &parent, sc_module_name name, params p, Uns32 INSTRUCTIONWidth=56, Uns32 DATAWidth=56)
