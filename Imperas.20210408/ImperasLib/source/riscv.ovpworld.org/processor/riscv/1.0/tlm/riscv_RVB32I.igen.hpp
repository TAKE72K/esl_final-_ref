...
class riscv_RVB32I : public tlmProcessor
{
  private:
    params paramsForProc(params p) {
        p.set("variant", "RVB32I");
        return p;
    }
  ...
  public:
    ...
    riscv_RVB32I(tlmModule &parent, sc_module_name name)
    ...
    riscv_RVB32I(tlmModule &parent, sc_module_name name, params p, Uns32 INSTRUCTIONWidth=34, Uns32 DATAWidth=34)
