...
class riscv_RV64I : public tlmProcessor
{
  private:
  ...
  public:
    ...
    riscv_RV64I(tlmModule &parent, sc_module_name name)
    ...
    riscv_RV64I(tlmModule &parent, sc_module_name name, params p, Uns32 INSTRUCTIONWidth=56, Uns32 DATAWidth=56)
