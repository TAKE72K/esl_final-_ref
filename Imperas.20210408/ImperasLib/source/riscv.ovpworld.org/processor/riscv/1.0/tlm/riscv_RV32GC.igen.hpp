...
class riscv_RV32GC : public tlmProcessor
{
  private:
    params paramsForProc(params p) {
        p.set("variant", "RV32GC");
        return p;
    }
  ...
  public:
    ...
    riscv_RV32GC(tlmModule &parent, sc_module_name name)
    ...
    riscv_RV32GC(tlmModule &parent, sc_module_name name, params p, Uns32 INSTRUCTIONWidth=34, Uns32 DATAWidth=34)
