...
class riscv_RV64GCV : public tlmProcessor
{
  private:
    params paramsForProc(params p) {
        p.set("variant", "RV64GCV");
        return p;
    }
  ...
  public:
    ...
    riscv_RV64GCV(tlmModule &parent, sc_module_name name)
    ...
    riscv_RV64GCV(tlmModule &parent, sc_module_name name, params p, Uns32 INSTRUCTIONWidth=56, Uns32 DATAWidth=56)
