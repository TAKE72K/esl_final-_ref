...
class riscv_RV64G : public tlmProcessor
{
  private:
  ...
  public:
    ...
    riscv_RV64G(tlmModule &parent, sc_module_name name)
    ...
    riscv_RV64G(tlmModule &parent, sc_module_name name, params p, Uns32 INSTRUCTIONWidth=56, Uns32 DATAWidth=56)
