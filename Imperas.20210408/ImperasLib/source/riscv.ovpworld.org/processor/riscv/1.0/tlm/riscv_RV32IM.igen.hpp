...
class riscv_RV32IM : public tlmProcessor
{
  private:
    params paramsForProc(params p) {
        p.set("variant", "RV32IM");
        return p;
    }
  ...
  public:
    ...
    riscv_RV32IM(tlmModule &parent, sc_module_name name)
    ...
    riscv_RV32IM(tlmModule &parent, sc_module_name name, params p, Uns32 INSTRUCTIONWidth=34, Uns32 DATAWidth=34)
