...
class riscv_RV32E : public tlmProcessor
{
  private:
  ...
  public:
    ...
    riscv_RV32E(tlmModule &parent, sc_module_name name)
    ...
    riscv_RV32E(tlmModule &parent, sc_module_name name, params p, Uns32 INSTRUCTIONWidth=34, Uns32 DATAWidth=34)
