...
class riscv_RV32GCN : public tlmProcessor
{
  private:
    params paramsForProc(params p) {
        p.set("variant", "RV32GCN");
        return p;
    }
  ...
  public:
    ...
    riscv_RV32GCN(tlmModule &parent, sc_module_name name)
    ...
    riscv_RV32GCN(tlmModule &parent, sc_module_name name, params p, Uns32 INSTRUCTIONWidth=34, Uns32 DATAWidth=34)
