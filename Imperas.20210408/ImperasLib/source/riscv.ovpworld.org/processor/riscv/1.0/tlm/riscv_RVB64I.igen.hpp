...
class riscv_RVB64I : public tlmProcessor
{
  private:
    params paramsForProc(params p) {
        p.set("variant", "RVB64I");
        return p;
    }
  ...
  public:
    ...
    riscv_RVB64I(tlmModule &parent, sc_module_name name)
    ...
    riscv_RVB64I(tlmModule &parent, sc_module_name name, params p, Uns32 INSTRUCTIONWidth=56, Uns32 DATAWidth=56)
