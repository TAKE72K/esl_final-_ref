...
class riscv_Ibex_RV32IC : public tlmProcessor
{
  private:
    params paramsForProc(params p) {
        p.set("variant", "Ibex_RV32IC");
        return p;
    }
  ...
  public:
    ...
    riscv_Ibex_RV32IC(tlmModule &parent, sc_module_name name)
    ...
    riscv_Ibex_RV32IC(tlmModule &parent, sc_module_name name, params p, Uns32 INSTRUCTIONWidth=34, Uns32 DATAWidth=34)
