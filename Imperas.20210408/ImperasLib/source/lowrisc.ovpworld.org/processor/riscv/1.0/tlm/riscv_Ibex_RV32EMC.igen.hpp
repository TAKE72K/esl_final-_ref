...
class riscv_Ibex_RV32EMC : public tlmProcessor
{
  private:
    params paramsForProc(params p) {
        p.set("variant", "Ibex_RV32EMC");
        return p;
    }
  ...
  public:
    ...
    riscv_Ibex_RV32EMC(tlmModule &parent, sc_module_name name)
    ...
    riscv_Ibex_RV32EMC(tlmModule &parent, sc_module_name name, params p, Uns32 INSTRUCTIONWidth=34, Uns32 DATAWidth=34)
