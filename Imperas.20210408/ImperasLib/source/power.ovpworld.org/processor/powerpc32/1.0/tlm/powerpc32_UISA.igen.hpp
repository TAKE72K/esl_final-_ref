...
class powerpc32_UISA : public tlmProcessor
{
  private:
  ...
  public:
    ...
    powerpc32_UISA(tlmModule &parent, sc_module_name name)
    ...
    powerpc32_UISA(tlmModule &parent, sc_module_name name, params p, Uns32 INSTRUCTIONWidth=32, Uns32 DATAWidth=32)
