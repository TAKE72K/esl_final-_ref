...
class ovp_mips64_r1r5_5KEc : public tlmProcessor
{
  private:
    ...
    const char *getModel() {
        const char *vlnv = opVLNVString (NULL, "mips.ovpworld.org", "processor", "mips64_r1r5", "1.0", OP_PROCESSOR, 1);
        if(!vlnv) {
            opMessage("F", "TLM_FFM", "Failed to find model mips.ovpworld.org/processor/mips64_r1r5/1.0");
        }
        return vlnv;
    }
  ...
  public:
    ...
    ovp_mips64_r1r5_5KEc(tlmModule &parent, sc_module_name name)
    ...
    ovp_mips64_r1r5_5KEc(tlmModule &parent, sc_module_name name, params p, Uns32 INSTRUCTIONWidth=32, Uns32 DATAWidth=32)
