...
class ovp_mips32_r1r5_74Kc : public tlmProcessor
{
  private:
  ...
  public:
    ...
    ovp_mips32_r1r5_74Kc(tlmModule &parent, sc_module_name name)
    ...
    ovp_mips32_r1r5_74Kc(tlmModule &parent, sc_module_name name, params p, Uns32 INSTRUCTIONWidth=32, Uns32 DATAWidth=32)
