...
A platform is constructed containing a single ARM_CORTEX_A processor instance, and a 
...
following may be available (actual applications available are demo dependent)
  - dhrystone.ARM_CORTEX_A.elf
  - linpack.ARM_CORTEX_A.elf
  - fibonacci.ARM_CORTEX_A.elf
  - peakSpeed2.ARM_CORTEX_A.elf
...
The simulation harness arm_single_tlm2.<OS>.exe was compiled 
...
cmd > arm_single_tlm2.<OS>.exe --program linpack.ARM_CORTEX_A.elf
...
The simulation platform arm_single_tlm2.<OS>.exe was compiled using MinGW/MSYS 
