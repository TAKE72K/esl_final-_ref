...
A platform is constructed containing a single OR1K processor instance, and a 
...
The simulation harness or1k_single_tlm2.<OS>.exe was compiled 
...
cmd > or1k_single_tlm2.<OS>.exe --program linpack.OR1K.elf
...
The simulation platform or1k_single_tlm2.<OS>.exe was compiled using MinGW/MSYS 
