...
A platform is constructed containing a single AARCH64 processor instance, and a 
...
following may be available (actual applications available are demo dependent)
  - dhrystone.AARCH64.elf
  - linpack.AARCH64.elf
  - fibonacci.AARCH64.elf
  - peakSpeed2.AARCH64.elf
...
The simulation harness arm_aarch64_single_tlm2.<OS>.exe was compiled 
...
cmd > arm_aarch64_single_tlm2.<OS>.exe --program linpack.AARCH64.elf
...
The simulation platform arm_aarch64_single_tlm2.<OS>.exe was compiled using MinGW/MSYS 
...
>make -f IMPERAS_HOME/ImperasLib/buildutils/Makefile.TLM.platform \
         SRC=arm_aarch64_single_tlm2.cpp
