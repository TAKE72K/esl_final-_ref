...
A platform is constructed containing a single ARC700 processor instance, and a 
...
The simulation harness arc_single_tlm2.<OS>.exe was compiled 
...
cmd > arc_single_tlm2.<OS>.exe --program linpack.ARC700.elf
...
The simulation platform arc_single_tlm2.<OS>.exe was compiled using MinGW/MSYS 
