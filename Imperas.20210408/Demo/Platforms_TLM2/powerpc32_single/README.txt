...
A platform is constructed containing a single POWERPC32 processor instance, and a 
...
following may be available (actual applications available are demo dependent)
  - dhrystone.POWERPC32.elf
  - linpack.POWERPC32.elf
  - fibonacci.POWERPC32.elf
  - peakSpeed2.POWERPC32.elf
...
The simulation harness powerpc32_single_tlm2.<OS>.exe was compiled 
...
cmd > powerpc32_single_tlm2.<OS>.exe --program linpack.POWERPC32.elf
...
The simulation platform powerpc32_single_tlm2.<OS>.exe was compiled using MinGW/MSYS 
