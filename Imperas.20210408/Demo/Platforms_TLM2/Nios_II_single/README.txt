...
A platform is constructed containing a single CS_NIOS2 processor instance, and a 
...
following may be available (actual applications available are demo dependent)
  - dhrystone.CS_NIOS2.elf
  - linpack.CS_NIOS2.elf
  - fibonacci.CS_NIOS2.elf
  - peakSpeed2.CS_NIOS2.elf
...
The simulation harness Nios_II_single_tlm2.<OS>.exe was compiled 
...
cmd > Nios_II_single_tlm2.<OS>.exe --program linpack.CS_NIOS2.elf
...
The simulation platform Nios_II_single_tlm2.<OS>.exe was compiled using MinGW/MSYS 
