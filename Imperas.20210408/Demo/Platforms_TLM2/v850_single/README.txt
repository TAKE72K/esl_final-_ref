...
A platform is constructed containing a single V850 processor instance, and a 
...
The simulation harness v850_single_tlm2.<OS>.exe was compiled 
...
cmd > v850_single_tlm2.<OS>.exe --program linpack.V850.elf
...
The simulation platform v850_single_tlm2.<OS>.exe was compiled using MinGW/MSYS 
